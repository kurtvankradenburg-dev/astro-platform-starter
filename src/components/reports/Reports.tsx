...
const sampleReports: Report[] = [
    ...
    { id: '4', title: 'Water pipe burst on Oak Avenue', description: 'Water pipe burst causing flooding on the street and nearby properties. Needs urgent repair from the municipal water department.', category: 'water-outages', status: 'resolved', location: 'Oak Avenue, Pretoria', author: 'Linda P.', createdAt: '2026-04-02T16:00:00Z', upvotes: 31 },
    ...
    { id: '6', title: 'Water outage in Sector 12', description: 'No water supply since early morning. Residents have not been informed about the cause or expected restoration time.', category: 'water-outages', status: 'open', location: 'Sector 12, Soweto', author: 'Nomsa D.', createdAt: '2026-04-10T06:00:00Z', upvotes: 45 },
];
